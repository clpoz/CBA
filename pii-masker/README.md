...
1. Download the LoRA weights of PII-Masker from [Hugging Face](https://huggingface.co/Ashishkr/llama2-PII-Masking) and place them in the `lora_weights` directory.
