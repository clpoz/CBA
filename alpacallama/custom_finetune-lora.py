...
def train():
    ...
    if model_args.model_name_or_path:
        model = AutoModelForCausalLM.from_pretrained(
            ...
            quantization_config=bnb_config_4bit if model_args.load_in_bits == 4 else bnb_config_8bit,# no quantization finetune
            device_map="auto"
        )  # .half().cuda()
    else:
    ...
    # merge old adapter
    lora_weight = 'lora_weights/alpaca-qlora-7b-chat'
    ...
    model.print_trainable_parameters()  # 39,976,960
